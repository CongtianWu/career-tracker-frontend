              ...
              <div className="absolute inset-0 flex items-center justify-center" style={{ zIndex: 20 }}>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-6">
                    Found {uploadResult?.extracted_skills?.length || 0} skills from your resume
                  </p>
                  ...
                  <div className="flex flex-wrap justify-center gap-2 max-w-md mx-auto mb-6">
                    ...
                    {uploadResult?.extracted_skills && uploadResult.extracted_skills.length > 6 && (
                      <motion.span
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        +{(uploadResult?.extracted_skills?.length || 0) - 6} more
                      </motion.span>
                    )}
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-apple-body">
                  Extracted <span className="font-bold accent-green">{uploadResult?.extracted_skills?.length || 0} skills</span> from your resume
                </p>
              </div>
              ...
              {uploadResult && uploadResult!.extracted_skills && uploadResult!.extracted_skills.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    {uploadResult && uploadResult!.extracted_skills && uploadResult!.extracted_skills.length > 12 && (
                      <motion.div 
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                      ...
                      >
                        ...
                        <span>{(uploadResult?.extracted_skills?.length || 0) - 12} more skills</span>
                      </motion.div>
                    )}
                  </div>
                </div>
              ...
              <div className="glass-apple rounded-apple-2xl p-4">
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-apple-logo-gray">{((uploadResult?.file_size || 0) / 1024).toFixed(1)} KB</div>
                  </div>
                  <div className="text-center">
